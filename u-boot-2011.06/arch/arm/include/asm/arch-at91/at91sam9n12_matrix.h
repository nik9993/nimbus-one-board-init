 ...
 * Based on AT91SAM9N12 datasheet.
 *
...
#ifndef __AT91SAM9N12_MATRIX_H
#define __AT91SAM9N12_MATRIX_H
...
/* eric REVISIT can not find this in datasheet? */
...
/* eric REVISIT can not find in datasheet? */
#define AT91_MATRIX_CS4A_SMC_CF1	(1 << 4)
#define AT91_MATRIX_CS5A_SMC_CF2	(1 << 5)

#define AT91_MATRIX_DBPUC		(1 << 8)
#define AT91_MATRIX_DBPDC		(1 << 9)

/* eric REVISIT can not find in datasheet? */
#define AT91_MATRIX_VDDIOMSEL_1_8V	(0 << 16)
#define AT91_MATRIX_VDDIOMSEL_3_3V	(1 << 16)

#define AT91_MATRIX_LOW_DRIVE		(0 << 17)
#define AT91_MATRIX_HIGH_DRIVE		(1 << 17)
