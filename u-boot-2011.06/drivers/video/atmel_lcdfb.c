...
#if defined(CONFIG_AT91SAM9N12)
#include <atmel_9n12_lcdc.h>
#endif
...
#if defined(CONFIG_AT91SAM9N12)
void lcd_9n12_ctrl_init(void *lcdbase)
{
	unsigned long value;
	lcd_dma_desc *desc;
	...
	lcdc_writel(panel_info.mmio, ATMEL_LCDC_BASECFG0,
			LCDC_BASECFG0_BLEN_AHB_INCR8 | LCDC_BASECFG0_DLBO);
...
#if defined(CONFIG_AT91SAM9N12)
	return lcd_9n12_ctrl_init(lcdbase);
#endif
